namespace Infrastructure.Helper.Translate;
public class ToWord
{
    ...
    {
        _intergerValue = (int)Number;
        var dec = Number - _intergerValue;
        if (dec > 0)
        {
            var desString = dec.ToString().Substring(2);
            _decimalValue = Convert.ToInt32(desString);
